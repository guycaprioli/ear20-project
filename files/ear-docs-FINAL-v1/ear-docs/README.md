...
> **Reviewers:** read `REVIEW-BRIEF.md` then `MANIFEST.md`. 60 decisions, 19 personas, runsheet S00–S21 — nothing built yet; every gap you find costs one edit, not a rewrite.
...
| # | Doc | What it is |
|---|---|---|
| 1 | `plan/GREENFIELD-DEVELOPMENT-PLAN-v1.md` | **The master plan**: 5-repo topology, work packages, milestones M0–M5, risks |
...
| 2 | `DECISION-LOG-v1.md` | Every decision + rationale; `[CLAUDE-DECIDED]` D-030…D-041 await Guy's post-effort review |
...
- **Next:** **M0/WP-D0 (Guy):** create repos + push; hunt Pass-2 code; answer Q-01…Q-05; review D-030…D-041. Then WP-D1 → M1 fixture-first.
